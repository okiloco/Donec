...
var Donec = function(){
    ...
    function createInstance(moduleID,args){
      var instance = component(moduleID,args),name, method;
      if (!debug) {
    ...
    function component(moduleID,args){
      var instance=modules[moduleID].creator(sandbox);
  ...
  return {
    init: function(){
      ...
      //sandbox.dispatchEvent("hola-mundo:init", this);
        ...
        //console.log(this);  
        sandbox.addEventListener("pre-mod_slide:hola", function(){
          console.log("Bla bla");
        });
...
Donec.onReady(function(){
  var m=Donec.create("mod_slide",{
    ...
    init:function(){
      ...
      me.addEventListener('pre-mod_slide:hola',function(){
        console.log(this);
